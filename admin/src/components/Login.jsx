...
const Login = ({setToken}) => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-[#000000]'>
        <div className='bg-[#FAFAFA] shadow-md rounded-lg px-8 py-6 max-w-md'>
            <h1 className='text-2xl font-bold mb-4 text-[#1D4ED8]'>Admin Panel</h1>
            <form onSubmit={onSubmitHandler}>
                ...
                <button className='mt-2 w-full py-2 px-4 rounded-md text-white bg-[#1D4ED8] hover:bg-[#3b82f6]' type="submit">Login</button>
            </form>
        </div>
    </div>
  )
